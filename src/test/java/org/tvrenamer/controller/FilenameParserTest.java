...
public class FilenameParserTest {
    ...
    public static void setupValues() {
        ...
        values.add(new TestInput("human.target.2010.s01.e02.720p.hdtv.x264-2hd.mkv", "human target 2010", "Human Target (2010)", "1", "2", "Rewind", "720p"));
        ...
        values.add(new TestInput("castle.2009.s01e09.720p.hdtv.x264-ctu.mkv", "castle 2009", "Castle (2009)", "1", "9", "Little Girl Lost", "720p"));
        ...
        values.add(new TestInput("American.Dad.S09E17.HDTV.x264-2HD.mp4", "american dad", "American Dad!", "9", "17", "The Full Cognitive Redaction of Avery Bullock by the Coward Stan Smith", ""));
        ...
        values.add(new TestInput("House.Of.Cards.2013.S01E06.HDTV.x264-EVOLVE.mp4", "house of cards 2013", "House of Cards (US)", "1", "6", "Chapter 6", ""));
        ...
        values.add(new TestInput("Reign.2013.S01E20.HDTV.x264-2HD.mp4", "reign 2013", "Reign (2013)", "1", "20", "Higher Ground", ""));
        ...
        values.add(new TestInput("The.Americans.2013.S02E10.HDTV.x264-LOL.mp4", "the americans 2013", "The Americans (2013)", "2", "10", "Yousaf", ""));
        ...
        values.add(new TestInput("law.and.order.svu.1705.hdtv-lol", "law and order svu", "Law & Order: Special Victims Unit", "17", "05", "Community Policing", ""));
        values.add(new TestInput("ncis.1304.hdtv-lol", "NCIS", "13", "04", "Double Trouble", ""));
        values.add(new TestInput("Marvels.Agents.of.S.H.I.E.L.D.S03E03.HDTV.x264-FLEET", "marvels agents of shield", "Marvel's Agents of S.H.I.E.L.D.", "3", "3", "A Wanted (Inhu)man", ""));
        values.add(new TestInput("Marvels.Agents.of.S.H.I.E.L.D.S03E10.HDTV.x264-KILLERS", "marvels agents of shield", "Marvel's Agents of S.H.I.E.L.D.", "3", "10", "Maveth", ""));
        values.add(new TestInput("Nip.Tuck.S06E01.720p.HDTV.X264-DIMENSION.mkv", "nip tuck", "Nip/Tuck", "6", "1", "Don Hoberman", "720p"));
        ...
        values.add(new TestInput("Marvels.Agents.of.S.H.I.E.L.D.S04E03.1080p.HDTV.x264-KILLERS[ettv].mkv", "marvels agents of shield", "Marvel's Agents of S.H.I.E.L.D.", "4", "3", "Uprising", "1080p"));
