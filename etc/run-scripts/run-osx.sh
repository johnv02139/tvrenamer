...
loclibs="swt-osx64-4.3.jar jedit-4.3.2-IOUtilities.jar xstream-1.3.1.jar"
...
for lib in ${dllibs}
do
  CLASSPATH=${CLASSPATH}':'${dllibloc}/${lib}
done
export CLASSPATH

java -XstartOnFirstThread org.tvrenamer.view.UIStarter
